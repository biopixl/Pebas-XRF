...
\begin{enumerate}
    ...
    \item \textbf{Integrated visualization:} Optical core images aligned with geochemical profiles for each core group enable direct correspondence between visual lithology and quantitative geochemistry, with shell-rich intervals identified as priority targets for paleontological sampling.

    \item \textbf{Reference framework:} This multi-proxy documentation provides a robust foundation for ongoing paleontological, sedimentological, and isotopic studies, with the convergence of XRF and optical evidence streams establishing confidence in paleoenvironmental interpretations.
\end{enumerate}
