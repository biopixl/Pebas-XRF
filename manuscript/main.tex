...
\begin{enumerate}
    ...
    \item \textbf{Museum fossil validation:} Portable XRF analysis of 13 Pebas Formation specimens from three museum collections (AMNH, UNMSM Lima, Harvard MCZ) independently validates the sedimentary geochemical framework. Fossil Sr/Ca ratios confirm freshwater depositional conditions, uranium uptake corroborates reducing burial environments inferred from sediment Fe/Mn, and site-specific diagenetic signatures (Steep Canyon vs.\ Carnivore Canyon) parallel the TAM--SC geochemical distinction. This integration of core scanning and museum specimen analysis identifies optimal preservation targets for isotopic paleoenvironmental reconstruction.
\end{enumerate}
