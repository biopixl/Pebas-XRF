...
\begin{figure}[h]
\centering
% \includegraphics[width=\textwidth]{figures/strat_example.png}
\fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}[Stratigraphic plot placeholder]\vspace{3cm}}}
...
\fbox{\parbox{0.8\textwidth}{\centering\vspace{4cm}[Ratio distribution plot placeholder]\vspace{4cm}}}
...
\fbox{\parbox{0.9\textwidth}{\centering\vspace{5cm}[PCA biplot placeholder]\vspace{5cm}}}
