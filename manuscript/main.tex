...
\usepackage{float} % Enable 'h' float specifier
...
\begin{abstract}
We present high-resolution XRF geochemistry from sediment cores of the Miocene Pebas Formation at two localities in the Peruvian Amazon: Tamshiyacu (TAM) and Santa Corina (SC). Twenty-seven core sections yield nearly 2,000 measurements at 3~mm resolution, documenting geochemical variability across $\sim$8~m of composite stratigraphy. Using a four-proxy approach (Ca for carbonate, Ti for terrigenous input, \FeMn{} for redox conditions, \ZrRb{} for grain size), we find that TAM sediments are consistently more reducing than SC (median \FeMn{} = 82 vs.\ 49), with 96\% of TAM measurements exceeding the reducing threshold compared to 47\% at SC. This difference holds across all sections and threshold values tested, indicating a genuine paleoenvironmental distinction between the localities. Low \ZrRb{} values at both sites confirm fine-grained, low-energy deposition consistent with the Pebas mega-wetland model. Spectral analysis reveals no statistically significant periodicities, precluding cyclostratigraphic interpretation without independent age control. Other proxy differences (higher Ti at SC, higher \ZrRb{} at TAM) are suggestive but not statistically robust with current sample sizes. We interpret TAM as representing a more distal or restricted part of the lake system with persistently stratified, oxygen-poor bottom waters, while SC experienced more variable redox conditions. Portable XRF analysis of museum fossil specimens corroborates the sedimentary geochemistry. This dataset provides the first continuous, high-resolution geochemical record from the Pebas Formation and establishes a framework for integrating XRF core scanning with paleontological and isotopic studies of this unique Miocene lake system.
\end{abstract}
...
% ==============================================================================
% Include revised statistical methods and site comparison (corrected for autocorrelation)
% ==============================================================================
...
% ==============================================================================
% Environmental Signal Analysis - Comprehensive proxy evaluation and ranking
% ==============================================================================
% TEMPORARILY DISABLED - uncomment after fixing:
%\input{sections/environmental_analysis}

% ==============================================================================
\section{Conclusions}
% ==============================================================================

This study presents the first high-resolution XRF geochemical record from the Pebas Formation, spanning 27 core sections and nearly 2,000 measurements across two localities in the Peruvian Amazon.

\textbf{Redox conditions differ between sites.} TAM sediments are consistently more reducing than SC, with higher Fe/Mn ratios (median 82 vs.\ 49) and a greater proportion of measurements exceeding the reducing threshold (96\% vs.\ 47\%). This difference is evident in every section examined and holds regardless of which threshold value is chosen. We interpret this as reflecting a more distal or restricted depositional setting at TAM, where bottom waters were persistently oxygen-poor.

\textbf{Both sites record low-energy lacustrine deposition.} Fine grain sizes indicated by low Zr/Rb values (median $<$ 1.0) are consistent with the Pebas mega-wetland model of shallow, extensive lake systems rather than energetic fluvial environments.

\textbf{No evidence for orbital cyclicity.} Apparent periodicities in Fe/Mn profiles cannot be distinguished from autocorrelated noise without independent age control. Cyclostratigraphic interpretation will require radiometric dates or biostratigraphic constraints.

\textbf{Other proxy patterns are suggestive but not definitive.} Higher Ti at SC and higher Zr/Rb at TAM hint at differences in terrigenous input and grain size, but these patterns do not reach statistical significance with current sample sizes and should be tested with additional data.

\textbf{Practical implications.} The geochemical framework established here provides context for paleontological sampling: shell-rich intervals (Ca $>$ 100 kcps) and redox transitions offer the best preservation potential for isotopic studies. The correspondence between XRF signals and visible lithological features confirms that core scanning captures genuine sedimentological variability.

This dataset establishes a template for XRF-based paleoenvironmental reconstruction in Neogene tropical lacustrine sequences and provides a foundation for integrating geochemistry with ongoing paleontological and isotopic work on the Pebas mega-wetland.
