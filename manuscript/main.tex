...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{../output/figures/qc_qa/qc_qa_summary.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{../output/figures/stratigraphic/composite_TAM.png}
\caption{Composite stratigraphic profiles for Tamshiyacu (TAM) cores showing Fe, Ti, Ca concentrations and Ca/Ti, Fe/Mn, K/Ti ratios. Note the generally high Fe/Mn values ($>$60) indicating reducing conditions throughout.}
\label{fig:strat_tam}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{../output/figures/stratigraphic/composite_SC.png}
\caption{Composite stratigraphic profiles for Santa Corina (SC) cores. SC shows lower overall Fe/Mn compared to TAM, though still above the oxic threshold.}
\label{fig:strat_sc}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{../output/figures/stratigraphic/ratio_distributions.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{../output/figures/pca/pca_analysis.png}
...
\begin{enumerate}
    ...
    \item \textbf{Redox conditions:} Elevated Fe/Mn ratios (50--85) at both sites indicate predominantly reducing bottom water conditions, consistent with a stratified lacustrine system.
