...
Mn (counts) & 1,565 & 5,499 & $<10^{-199}$ & $\sim$3.5$\times$ higher Mn at SC \\
\bottomrule
\end{tabular}
\end{table}
...
TAM-5AB-6-7-B-RUN2 & TAM & 111 & 444 & 7--174 & Oxygenation cycles \\
TAM-5AB-6-7-C & TAM & 237 & 472 & 39--159 & Most measurements; stable baseline \\
SC-5-6-7ABC-B & SC & 173 & 408 & 19--115 & Best SC section; clear transitions \\
\bottomrule
\end{tabular}
\end{table}
