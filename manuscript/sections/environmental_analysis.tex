...
Major environmental transitions were identified using a rolling-window analysis (5-point window) to detect shifts $>50\%$ in key proxy values. Stratigraphic columns are plotted with depth increasing downward, such that the top of each profile represents younger (more recent) sediments and the base represents older sediments. Three exemplary sections illustrate different transition styles (Figure~\ref{fig:stratigraphic_profiles}).
...
This section records the most extreme redox variability in the dataset. Reading from base to top (older to younger):
\begin{itemize}
\item \textbf{156--207 mm:} Upward increase in Ca/Ti (88--167\%), indicating a \textbf{carbonate enrichment event} through time
\item \textbf{327--339 mm:} Upward increase in Mn/Ti (60--85\%) while Fe/Mn drops 52\%, marking a \textbf{transition to more oxidizing conditions} in younger sediments
\item Fe/Mn ranges from 89 to 1327, spanning nearly two orders of magnitude across the section
\end{itemize}

\subsubsection{TAM-3A-4-5CDE-B (448--1012 mm)}

This section shows well-defined carbonate pulses through time:
\begin{itemize}
\item \textbf{472--478 mm:} Upward increase in Ca/Ti (62--125\%), representing a \textbf{major carbonate pulse}
\item \textbf{487--493 mm:} Subsequent upward increase in Fe/Mn (53--73\%), indicating \textbf{return to reducing conditions} in younger sediments
\end{itemize}
...
\begin{itemize}
\item \textbf{294--298 mm:} Simultaneous upward increase in Ca/Ti (83--144\%) and Mn/Ti (80--103\%), indicating a \textbf{combined carbonate enrichment and oxygenation event} progressing into younger sediments
\end{itemize}
