...
\begin{itemize}
\item \textbf{156--207 mm depth:} Ca/Ti increases by 88--167\% across this interval, recording a \textbf{carbonate enrichment event}
\item \textbf{327--339 mm depth:} Mn/Ti increases by 60--85\% while Fe/Mn decreases by 52\%, marking a \textbf{transition to more oxidizing conditions}
\item Fe/Mn ranges from 89 to 1327 across the full section, spanning nearly two orders of magnitude
\end{itemize}
...
\begin{itemize}
\item \textbf{472--478 mm depth:} Ca/Ti increases by 62--125\%, recording a \textbf{major carbonate pulse}
\item \textbf{487--493 mm depth:} Fe/Mn increases by 53--73\%, indicating a \textbf{return to more reducing conditions}
\end{itemize}
...
\begin{itemize}
\item \textbf{294--298 mm depth:} Ca/Ti and Mn/Ti increase simultaneously (83--144\% and 80--103\%, respectively), recording a \textbf{combined carbonate enrichment and oxygenation event}
\end{itemize}
