...
\item[Titanium (Ti):] Frequently used as a detrital proxy because Ti resides primarily in heavy minerals (ilmenite, rutile, titanite) and is immobile during diagenesis \citep{Calvert2007}. Ti provides excellent XRF signal strength (median 11,408 cps) but shows the \textit{largest site difference} in our dataset (SC 43\% higher than TAM), indicating that Ti tracks genuine depositional differences rather than serving as a passive normalizer.
